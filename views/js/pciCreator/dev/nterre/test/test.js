...
define([
    ...
    'json!pciWiquid/pciCreator/dev/nterre/test/data/qti.json'
    ...
    pciTestProvider.addManifestPath(
        'nterre',
        'pciWiquid/pciCreator/dev/nterre/pciCreator.json');
    ...
    QUnit.asyncTest('display and play', function (assert){
        ...
        runner = qtiItemRunner('qti', itemData)
            .on('render', function (){
                    QUnit.start();
                    assert.equal($container.find('.nterre').length,1,'The container contains nterre' );
