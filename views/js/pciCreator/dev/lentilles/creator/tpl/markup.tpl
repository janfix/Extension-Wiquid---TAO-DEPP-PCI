...
<p>À partir des photographies de Justin et Héloïse, réaliser un tableau puis un graphique présentant la taille de la pousse en fonction du temps. 
 <ul>
 	<li class='etape1 retourEtape1'>Etape 1 : créer un tableau en précisant les titres des lignes ou/et des colonnes</li>
 	<li class='etape2 btgraphor'>Etape 2 : créer un graphique en précisant bien tous les éléments nécessaires à sa compréhension</li>
 </ul>
</p>
</div>
...
<div class="graphor" id="graphor"></div>
