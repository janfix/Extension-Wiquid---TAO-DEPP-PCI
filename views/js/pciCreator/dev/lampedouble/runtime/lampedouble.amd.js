define(['qtiCustomInteractionContext', 'IMSGlobal/jquery_2_1_1', 'lampedouble/runtime/js/renderer', 'OAT/util/event'], function(qtiCustomInteractionContext, $, renderer, event){
...
//            var assetManager = qtiCustomInteractionContext.getAssetResolver(this.getTypeIdentifier());//that would introduce dependency between the asset manager and global pci runtime context
    ...
    qtiCustomInteractionContext.register(lampedouble);
});