...
var quantifb = 30;// attention cela fait 30 + 30 + (30/4) à cause des trois zones de l'image
var quantifj = 60;
var quantifr = 30;
...
$(".pesticide").mouseup(function(event) {
    ...
    if(this.value ==0 && otherslider ==0 ){
        ...
        for (var i = 0; i < group1.length; i++) {
            blueset[group1[i]].animate({ "opacity": "1" }, 2000); // apparition de 25%
            redset[group1[i]].animate({ "opacity": "1" }, 2000);// apparition de 25%
        }
        for (var i = 0; i < group2.length; i++) {
            blueset[group2[i]].animate({ "opacity": "1" }, 2000); // apparition de 25%
            redset[group2[i]].animate({ "opacity": "1" }, 2000);// apparition de 25%
        }
        for (var i = 0; i < group3.length; i++) {
            blueset[group3[i]].animate({ "opacity": "1" }, 2000); // apparition de 25%
            redset[group3[i]].animate({ "opacity": "1" }, 2000);// apparition de 25%
        }
        for (var i = 0; i < group4.length; i++) {
            blueset[group4[i]].animate({ "opacity": "1" }, 2000); // apparition de 25%
            redset[group4[i]].animate({ "opacity": "1" }, 2000);// apparition de 25%
        }
 
        // Effectif = 8
        var actionbee = 8 - beepresente;
        if(actionbee >0 ){beefly(actionbee);}
        else{ console.log('pas utile ici');}
        popu.remove();
        population(80000);
    ...
    if(this.value==1 && otherslider ==0){
        ...
        for (var i = 0; i < group1.length; i++) {
            blueset[group1[i]].animate({ "opacity": "0" }, 2000); // disparition de 25%
            redset[group1[i]].animate({ "opacity": "0" }, 2000);// disparition de 25%
        }
        for (var i = 0; i < group2.length; i++) {
            blueset[group2[i]].animate({ "opacity": "1" }, 2000); // apparition de 25%
            redset[group2[i]].animate({ "opacity": "1" }, 2000);// apparition de 25%
    ...
    if(this.value==1 && otherslider ==2){
        ...
        for (var i = 0; i < group2.length; i++) {
            blueset[group2[i]].animate({ "opacity": "0" }, 2000); // disparition de 25%
            redset[group2[i]].animate({ "opacity": "0" }, 2000);// disparition de 25%
        }

        for (var i = 0; i < group3.length; i++) {
                    blueset[group3[i]].animate({ "opacity": "0" }, 2000); // disparition de 25%
                    redset[group3[i]].animate({ "opacity": "0" }, 2000);// disparition de 25%
                }
        for (var i = 0; i < group4.length; i++) {
            blueset[group4[i]].animate({ "opacity": "1" }, 2000); // apparition de 25%
            redset[group4[i]].animate({ "opacity": "1" }, 2000);// apparition de 25%
    ...
    if(this.value==2 && otherslider ==0){
        ...
        for (var i = 0; i < group3.length; i++) {
                    blueset[group3[i]].animate({ "opacity": "1" }, 2000); // disparition de 25%
                    redset[group3[i]].animate({ "opacity": "1" }, 2000);// disparition de 25%
                }
        for (var i = 0; i < group4.length; i++) {
            blueset[group4[i]].animate({ "opacity": "1" }, 2000); // apparition de 25%
            redset[group4[i]].animate({ "opacity": "1" }, 2000);// apparition de 25%
    ...
    if(this.value==2 && otherslider ==2){
        ...
        for (var i = 0; i < group4.length; i++) {
            blueset[group4[i]].animate({ "opacity": "0" }, 2000); // disparition de 25%
            redset[group4[i]].animate({ "opacity": "0" }, 2000);// disparition de 25%
        }
