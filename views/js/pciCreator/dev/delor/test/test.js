...
define([
    ...
    'json!pciWiquid/pciCreator/dev/delor/test/data/qti.json'
    ...
    pciTestProvider.addManifestPath(
        'delor',
        'pciWiquid/pciCreator/dev/delor/pciCreator.json');
    ...
    QUnit.asyncTest('display and play', function (assert){
        ...
        runner = qtiItemRunner('qti', itemData)
            .on('render', function (){
                    QUnit.start();
                    assert.equal($container.find('.delor').length,1,'The container contains delor' );
