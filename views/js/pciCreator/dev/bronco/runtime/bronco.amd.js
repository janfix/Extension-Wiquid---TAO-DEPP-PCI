define(['qtiCustomInteractionContext', 'IMSGlobal/jquery_2_1_1', 'bronco/runtime/js/renderer', 'OAT/util/event'], function(qtiCustomInteractionContext, $, renderer, event){

    var bronco = {
        id : -1,
        getTypeIdentifier : function(){
            return 'bronco';// Récupère l'identifiant du TYPE d'ITEM
        },
        /**
         * Render the PCI : 
         * @param {String} id
    ...
    qtiCustomInteractionContext.register(bronco);
});