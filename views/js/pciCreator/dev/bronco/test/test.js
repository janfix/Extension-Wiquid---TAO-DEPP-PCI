...
define([
    ...
    'json!pciWiquid/pciCreator/dev/bronco/test/data/qti.json'
    ...
    pciTestProvider.addManifestPath(
        'bronco',
        'pciWiquid/pciCreator/dev/bronco/pciCreator.json');
    ...
    QUnit.asyncTest('display and play', function (assert){
        ...
        runner = qtiItemRunner('qti', itemData)
            .on('render', function (){
                    QUnit.start();
                    assert.equal($container.find('.bronco').length,1,'The container contains bronco' );
