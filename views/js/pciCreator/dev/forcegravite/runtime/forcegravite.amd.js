define(['qtiCustomInteractionContext', 'IMSGlobal/jquery_2_1_1', 'forcegravite/runtime/js/renderer', 'OAT/util/event'], function(qtiCustomInteractionContext, $, renderer, event) {

    var forcegravite = {
        id: -1,
        getTypeIdentifier: function() {
            return 'forcegravite'; // Récupère l'identifiant du TYPE d'ITEM
        },
        /**
         * Render the PCI : 
         * @param {String} id
    ...
    qtiCustomInteractionContext.register(forcegravite);
});
