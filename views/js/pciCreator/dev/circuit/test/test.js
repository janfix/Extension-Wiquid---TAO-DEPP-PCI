...
define([
    ...
    'json!pciWiquid/pciCreator/dev/circuit/test/data/qti.json'
    ...
    pciTestProvider.addManifestPath(
        'circuit',
        'pciWiquid/pciCreator/dev/circuit/pciCreator.json');
    ...
    QUnit.asyncTest('display and play', function (assert){
        ...
        runner = qtiItemRunner('qti', itemData)
            .on('render', function (){
                    QUnit.start();
                    assert.equal($container.find('.circuit').length,1,'The container contains circuit' );
