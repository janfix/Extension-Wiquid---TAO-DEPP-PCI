define(['IMSGlobal/jquery_2_1_1', 
    ...
    function renderChoices(id, $container, config, assetManager){
        ...
        //var flopfluid = paper.path('m 355,180 -0.53572,50 45.71429,-0.17857 0.17857,-50 -23.21429,0.71428 z').attr({ fill: 'yellow', 'stroke-opacity': 0, 'fill-opacity': 0 });
        ...
        //var puree1 = paper.text(605, 250, 'Verser la purée fluide').attr({'text-anchor': 'start', 'stroke' : '#545454', 'font-size': 16, cursor:'pointer'}).hide();
        ...
        //var puree2 = paper.text(605, 220, 'Verser la purée compacte').attr({'text-anchor': 'start', 'stroke' : '#545454', 'font-size': 16 , cursor:'pointer'});
        ...
        //var bouchon = paper.text(605, 320, 'Fermer le bouchon').attr({'text-anchor': 'start', 'stroke' : '#545454', 'font-size': 16 , cursor:'pointer'});
        ...
        var activpuree;
        var splizz; // cachet effervescnet
        ...
        for (var start = 1; start < 30; start++){
            ...
            setTimeout(function(){btzeroset.forEach(
                        function(e) {
                            e.show();
                        }); }, 30000);
        }
