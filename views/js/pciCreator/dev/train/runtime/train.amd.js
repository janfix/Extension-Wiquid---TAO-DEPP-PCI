define(['qtiCustomInteractionContext', 'IMSGlobal/jquery_2_1_1', 'train/runtime/js/renderer', 'OAT/util/event'], function(qtiCustomInteractionContext, $, renderer, event){

    var train = {
        id : -1,
        getTypeIdentifier : function(){
            return 'train';// Récupère l'identifiant du TYPE d'ITEM
        },
        /**
         * Render the PCI : 
         * @param {String} id
    ...
    qtiCustomInteractionContext.register(train);
});