...
define([
    ...
    'json!pciWiquid/pciCreator/dev/volcanisme/test/data/qti.json'
    ...
    QUnit.asyncTest('display and play', function (assert){
        ...
        runner = qtiItemRunner('qti', itemData)
            .on('render', function (){
                    QUnit.start();
                    assert.equal($container.find('.volcanisme').length,1,'The container contains volcanisme' );
