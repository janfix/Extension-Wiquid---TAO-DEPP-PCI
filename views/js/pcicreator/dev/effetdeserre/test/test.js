...
define([
    ...
    'json!pciWiquid/pciCreator/dev/effetdeserre/test/data/qti.json'
    ...
    QUnit.asyncTest('display and play', function (assert){
        ...
        runner = qtiItemRunner('qti', itemData)
            .on('render', function (){
                    QUnit.start();
                    assert.equal($container.find('.effetdeserre').length,1,'The container contains effetdeserre' );
